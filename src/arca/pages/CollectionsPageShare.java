...
public class CollectionsPageShare extends Navigation {

	static WebDriver driver;
	static Actions actions;

	private static Logger log = Logger.getLogger(CollectionsPageShare.class.getName());
	public static String Home_Page = "https://ecsdev.solix.com/";
	public CollectionsPageShare(WebDriver driver) {
		super(driver);
		this.driver = driver;
			...
			try
			{
				...
				*/
				...
				for(int i=0;i<each_folder_li_tag.size();i++)
				{
					...
					if(each_li.contains("Share +") || each_li.contains("Add/View Comment") || each_li.contains("Add/View Tags") || each_li.contains("Copy / Move") || each_li.contains("Download") || each_li.contains("Trash"))
					{
