...
public class MyFilesDelete extends Navigation {
	...
	else
	{
		...
		log.error("Error in files restore");	
		captureScreenShot(ScreenShotsFilePath + "files_restore_failed_Error.png");
		Thread.sleep(2000);
	...
	*/
	...
	else
	{
		...
		log.error("Error in folders moved to trash");	
		captureScreenShot(ScreenShotsFilePath + "folders_moved_to_trash_failed.png");
		Thread.sleep(2000);
		ATUReports.add("folders moved to trash failed","folders moved to trash",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
	...
	else
	{
		...
		log.error("Error in folders restore");	
		captureScreenShot(ScreenShotsFilePath + "folders_restore_failed_Error.png");
		Thread.sleep(2000);
	...
	else
	{
		...
		log.error("Error in moving files and folders to trash");	
		captureScreenShot(ScreenShotsFilePath + "files_folders_moved_to_trash_failed_Error.png");
		Thread.sleep(2000);
		ATUReports.add("files and folders moved to trash failed","files and folders moved to trash",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
