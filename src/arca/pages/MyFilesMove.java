	...
	public static void multiple_files_move()
	{
		...
		try
		{
			...
			*/
			...
			WebDriverWait wait101 = new WebDriverWait(driver, 60);
			wait101.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='folder']"))).getText().contains(multiple_file_move_folder_name);
			Thread.sleep(2000);
			...
			actions.doubleClick(getPageObject("copy_mydrive")).perform();
	...
	public static void multiple_folders_move()
	{
		...
		try
		{
			...
			*/
			...
			WebDriverWait wait106 = new WebDriverWait(driver, 60);
			wait106.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='folder']"))).getText().contains(multiple_folder_move_folder_name);
			Thread.sleep(2000);
	...
	public static void multiple_files_folders_move()
	{
		...
		try
		{
			...
			*/
			...
			WebDriverWait wait120 = new WebDriverWait(driver, 60);
			wait120.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='folder']"))).getText().contains(multiple_files_folders_move_folder_name);
			Thread.sleep(2000);
